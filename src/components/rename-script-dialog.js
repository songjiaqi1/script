...
class RenameScriptDialog extends React.Component {
  ...
  handleSubmit = () => {
    ...
    this.props.renameScript(scriptName);
  }
  ...
  render() {
    return (
      <Modal isOpen={true} toggle={this.toggle} autoFocus={false}>
        <ModalHeader toggle={this.toggle}>{intl.get('Rename_script')}</ModalHeader>
        <ModalBody>
          <Form>
            <FormGroup>
...
export default RenameScriptDialog;